...
# https://git-cral.univ-lyon1.fr/MUSE/mpdaf/-/blob/23d52ba059fe76df5e1655542b17a28a7137cf20/LICENSE
"""
        ...
        if reftarget not in mapping:
            ...
            if reftype in ("class",) and "." in reftarget and reftarget not in mapping:
                ...
                if (
                    ...
                    and prefix in env.intersphinx_named_inventory
                ):

                    if reftarget in env.intersphinx_named_inventory[prefix]["py:class"]:
                        newtarget = env.intersphinx_named_inventory[prefix]["py:class"][
                            reftarget
                        ][2]
